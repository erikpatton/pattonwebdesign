...
function executive_load_scripts() {
	...
	wp_enqueue_script( 'jquerydemo', get_bloginfo( 'stylesheet_directory' ) . '/js/jquery-demo.js', array( 'jquery' ), '1.0.0' );
	
	wp_enqueue_script( 'demo', get_bloginfo( 'stylesheet_directory' ) . '/js/demo.js' );
	...
	wp_enqueue_style( 'google-font', '//fonts.googleapis.com/css?family=Raleway:400,700,300|Lato:400,700,300italic', array(), CHILD_THEME_VERSION );
}
...
genesis_register_sidebar( array(
	'id'          => 'home-divider',
	'name'        => __( 'Home - Divider', 'executive' ),
	'description' => __( 'This is a divider for the home page.', 'executive' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-divider2',
	'name'        => __( 'Home - Divider 2', 'executive' ),
	'description' => __( 'This is a divider for the home page.', 'executive' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-divider3',
	'name'        => __( 'Home - Divider 3', 'executive' ),
	'description' => __( 'This is a divider for the home page.', 'executive' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-divider4',
...
genesis_register_sidebar( array(
	'id'          => 'home-photo',
	'name'        => __( 'Home - Photo', 'executive' ),
	'description' => __( 'Home photo.', 'executive' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-hosting',
	'name'        => __( 'Home - Hosting', 'executive' ),
	'description' => __( 'Home hosting.', 'executive' ),
) );
